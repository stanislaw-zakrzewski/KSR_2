...
class LinguisticVariableNASDelay extends LinguisticVariable {
    LinguisticVariableNASDelay() {
        ...
        membershipFunctions.put(labels.get(1), new MembershipFunctionGammaClass(100, 300));
        membershipFunctions.put(labels.get(2), new MembershipFunctionGammaClass(300, 2000000000));
    }
}
