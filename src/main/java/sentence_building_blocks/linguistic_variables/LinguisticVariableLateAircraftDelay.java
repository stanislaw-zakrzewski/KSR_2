...
class LinguisticVariableLateAircraftDelay extends LinguisticVariable {
    LinguisticVariableLateAircraftDelay() {
        ...
        membershipFunctions.put(labels.get(1), new MembershipFunctionSClass(50, 150));
        membershipFunctions.put(labels.get(2), new MembershipFunctionSClass(150, 2000000000));
    }
}
