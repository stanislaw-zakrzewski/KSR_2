...
class LinguisticVariableCarrierDelay extends LinguisticVariable {
    LinguisticVariableCarrierDelay() {
        ...
        membershipFunctions.put(labels.get(1), new MembershipFunctionTrapezoidal(40,70, 190,210));
        membershipFunctions.put(labels.get(2), new MembershipFunctionGammaClass(200, 240));
    }
}
