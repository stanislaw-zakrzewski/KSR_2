...
class LinguisticVariableWeatherDelay extends LinguisticVariable {
    LinguisticVariableWeatherDelay() {
            ...
            membershipFunctions.put(labels.get(0), new MembershipFunctionSClass(0, 250));
            membershipFunctions.put(labels.get(1), new MembershipFunctionSClass(250, 600));
            membershipFunctions.put(labels.get(2), new MembershipFunctionSClass(600, 2000000000));
    }
}
